 ...
 */
function lisbonOffsetMinutes(naiveUtcMs: number): number {
 ...
 */
export function sessionLisbonTimestampMs(
  scheduledDate: unknown,
  scheduledTime: unknown
): number | null {
  if (typeof scheduledDate !== 'string' || typeof scheduledTime !== 'string') return null;
...
export function formatSessionDateForEmail(
  scheduledDate: unknown,
  scheduledTime: unknown,
  locale: 'pt' | 'en' | 'es' | 'fr'
): string {
